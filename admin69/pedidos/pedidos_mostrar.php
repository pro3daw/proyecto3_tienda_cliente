            ...
            <header class="head">
                ...
                <div class="main-bar">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            <div class="span12">
                                <h3><i class="icon-shopping-cart"></i> Orders - Admin Panel</h3>
                            </div>
                        </div>
                        <!-- /.row-fluid -->
                    </div>
                            ...
                            <div class="row-fluid" id="dialog_modify" style="visibility: hidden">
                                <div class="span6">
                                    ...
                                    <form id="modify_product_data">
                                        <input type="text" placeholder="ID_order" name="id_pedido" id="id_pedido" readonly><br>
                                        <input type="text" placeholder="ID_client" name="id_usuario" id="id_usuario"><br>
                                        <select name="estado_envio" id="estado_envio">
                                            <option value="pendiente">Pending</option>
                                            <option value="enviado">Send</option>
                                            <option value="cancelado">Canceled</option>
                                        </select><br>
                                        <input type="text" placeholder="Price" name="precio_pedido" id="precio_pedido"><br>
                                    </form>
                                </div>
                            </div>
                            <div class="row-fluid" id="dialog" style="visibility: hidden">
                                <div class="span6">
                                    ...
                                    <form id="new_product_data">
                                        <input type="text" placeholder="ID_order" name="id_pedido"><br>
                                        <input type="text" placeholder="ID_client" name="id_usuario"><br>
                                        <select name="estado_envio">
                                            <option value="pendiente">Pending</option>
                                            <option value="enviado">Send</option>
                                            <option value="cancelado">Canceled</option>
                                        </select><br>
                                        <input type="text" placeholder="Precio" name="precio_pedido"><br>
                                    </form>
                                </div>
                            </div>
