...
$SQL = "UPDATE usuarios SET id_usuario=$id_usuario, nombre='$nombre', apellidos='$apellidos', password='$password', mail='$mail', codpos='$codpos', direccion='$direccion', ciudad='$ciudad', provincia='$provincia', nombre='$nombre' WHERE id_usuario=$id_usuario;";
